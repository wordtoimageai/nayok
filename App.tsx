  ...
  return (
    <div className="font-sans">
            ...
            <main className="flex-grow relative flex flex-col md:flex-row overflow-hidden">
              ...
              <div className="absolute top-4 right-4 z-40 flex gap-2">
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 bg-white/80 backdrop-blur-md border border-stone-200 rounded-full shadow-sm hover:bg-stone-50 transition-all text-stone-700 font-medium text-sm"
                >
                ...
                {!isLoading && displayImageUrl && (
                  ...
                  >
                    <button
                      ...
                      className="flex items-center gap-2 px-6 py-3 bg-stone-900 text-white rounded-full shadow-xl hover:bg-stone-800 transition-all font-bold text-sm tracking-wide"
                    >
      ...
      <LookbookModal 
        ...
        entries={lookbook}
        onRemove={handleRemoveFromLookbook}
      />
